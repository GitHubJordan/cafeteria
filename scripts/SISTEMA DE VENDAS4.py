...
txtLatte=Entry (frameflaa,font=('arial',16,'bold'),bd=1,width=6,justify='left',state=DISABLED)
...
txtLatte=Entry (frameflab,font=('arial',16,'bold'),bd=1,width=6,justify='left',state=DISABLED)
txtLatte.grid(row=0,column=1)
txtLatte=Entry (frameflab,font=('arial',16,'bold'),bd=1,width=6,justify='left',state=DISABLED)
txtLatte.grid(row=1,column=1)
txtLatte=Entry (frameflab,font=('arial',16,'bold'),bd=1,width=6,justify='left',state=DISABLED)
...
cmdTotal=Button(framefb2,padx=16,pady=1,bg='black',bd=4,fg='green',font=('arial',12,'bold'),width=5,
...
lblCustobebidas = Entry(framef2aa,font=('arial',9,'bold'),bd=2,justify='left')
lblCustobebidas.grid(row=0,column=1)


lblCustobolos = Label(framef2aa,font=('arial',12,'bold'),text="Custo Bolos:",bd=2)
lblCustobolos.grid(row=1,column=0,sticky=W)

lblCustobolos = Entry(framef2aa,font=('arial',9,'bold'),bd=2,justify='left')
lblCustobolos.grid(row=1,column=1)


lblTaxaservicos = Label(framef2aa,font=('arial',12,'bold'),text="Taxa Servicos:",bd=2)
lblTaxaservicos.grid(row=2,column=0,sticky=W)

lblTaxaservicos = Entry(framef2aa,font=('arial',9,'bold'),bd=2,justify='left')
lblTaxaservicos.grid(row=2,column=1)


# =========================== CRIANDO OS CAMPOS DO RODAPE FRAME DA DIREITA ==============================

lblImposto = Label(framef2ab,font=('arial',12,'bold'),text="Imposto:",bd=2)
lblImposto.grid(row=0,column=0,sticky=W)

lblImposto = Entry(framef2ab,font=('arial',11,'bold'),bd=2,justify='left')
lblImposto.grid(row=0,column=1)


lblSubtotal = Label(framef2ab,font=('arial',12,'bold'),text="Sub Total:",bd=2)
lblSubtotal.grid(row=1,column=0,sticky=W)

lblSubtotal = Entry(framef2ab,font=('arial',11,'bold'),bd=2,justify='left')
...
lblTotal = Entry(framef2ab,font=('arial',11,'bold'),bd=2,justify='left')
